  ...
  <div class="menu-create">
    <el-card class="box-card">
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item>
          <el-button :loading="isCreateMenuLoading" type="primary" @click="onSubmit">提交</el-button>
          <el-button
            v-if="!isEdit"
          >重置</el-button>
        </el-form-item>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async onSubmit () {
      ...
      this.isCreateMenuLoading = false
    }
  }
})
</script>
